...
export default function Contact() {
  ...
  const contacts = [
    ...
    { icon: <Linkedin size={20} />, label: 'LinkedIn', value: 'https://www.linkedin.com/in/harshal-katware-324220236/?skipRedirect=true', href: 'https://linkedin.com/in/harshalkatware', color: 'from-blue-600 to-blue-500' },
